...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'organizations_organization', (
            ...
            ('image', self.gf('django.db.models.fields.files.ImageField')(default='/static/main/img/group.png', max_length=256)),
            ('slug', self.gf('django_extensions.db.fields.AutoSlugField')(allow_duplicates=False, max_length=200, separator=u'-', blank=True, unique=True, populate_from='name', overwrite=False)),
        ...
        db.send_create_signal(u'organizations', ['OrganizationUser'])
        ...
        db.create_table(u'organizations_organizationowner', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ...
        db.send_create_signal(u'organizations', ['OrganizationOwner'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'organizations_organizationowner')
    ...
    models = {
        ...
        u'organizations.organization': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.files.ImageField', [], {'default': "'/static/main/img/group.png'", 'max_length': '256'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'slug': ('django_extensions.db.fields.AutoSlugField', [], {'allow_duplicates': 'False', 'max_length': '200', 'separator': "u'-'", 'blank': 'True', 'unique': 'True', 'populate_from': "'name'", 'overwrite': 'False'}),
        ...
        u'organizations.organizationowner': {
            ...
            'organization_user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'owned_organization'", 'unique': 'True', 'to': u"orm['organizations.OrganizationUser']"})
        },
