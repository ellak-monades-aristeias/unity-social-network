...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'organizations_organization', 'image',
                      self.gf('django.db.models.fields.CharField')(default='/static/main/img/group.png', max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.image'
        db.delete_column(u'organizations_organization', 'image')
    ...
    models = {
        ...
        u'organizations.organization': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.CharField', [], {'default': "'/static/main/img/group.png'", 'max_length': '256'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
