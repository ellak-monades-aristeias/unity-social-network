...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Organization.image'
        db.alter_column(u'organizations_organization', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Organization.image'
        db.alter_column(u'organizations_organization', 'image', self.gf('django.db.models.fields.CharField')(max_length=256))
